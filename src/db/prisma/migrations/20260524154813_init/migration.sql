-- CreateEnum
CREATE TYPE "ResourceType" AS ENUM ('TEMPLATE_EXERCISE', 'ARTICLE', 'COURSE', 'RESOURCE_GROUP', 'TABLE');

-- CreateEnum
CREATE TYPE "ResourceStatus" AS ENUM ('PUBLIC', 'LINKONLY', 'PRIVATE');
...
CREATE TABLE "Resource" (
    ...
    "visibility" "ResourceStatus" NOT NULL DEFAULT 'PUBLIC',
    "data" JSONB NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Resource_handle_type_key" ON "Resource"("handle", "type");
